        ...
        findViewById(R.id.trip_details_share).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String message = String.format(getResources().getString(R.string.trip_details_share_message_content),
                        DBHelper.getInstance().getBikeNetworkName(getApplicationContext()), getListPagerAdapter().getHighlightedStationForPage(StationListPagerAdapter.DOCK_STATIONS).getName(),
            ...
            if (null != clickedStation) {
                ...
                if (newState) {
                    ...
                    if (mStationMapFragment.getMarkerPickedPlaceVisibleName().isEmpty())
                        addFavorite(clickedStation.getFavoriteEntityForDisplayName(clickedStation.getName()));
                    else {   //there's a third destination
                        addFavorite(clickedStation.getFavoriteEntityForDisplayName(mStationMapFragment.getMarkerPickedPlaceVisibleName()));
                    }
