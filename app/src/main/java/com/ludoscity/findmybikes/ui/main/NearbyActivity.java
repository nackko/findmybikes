...
import com.ludoscity.findmybikes.ui.sheet.FavoriteSheetListViewModel;
...
public class NearbyActivity extends AppCompatActivity
        implements FavoriteListFragment.OnFavoriteListFragmentInteractionListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onChanged(@Nullable String newBikeSystemId) {
                ...
                if (getString(R.string.app_version_name).contains("test") || getString(R.string.app_version_name).contains("alpha")){
                    ...
                    for(BikeStation station : networkStationList) {
                        if (!mFavoriteSheetListViewModel.isFavorite(station.getLocationHash())) {
                            ...
                            if (addedCount > 3)
                                ...
                                mFavoriteSheetListViewModel.addFavorite(testFavToAdd);
                            }
                            else{   //default favorite name
                                mFavoriteSheetListViewModel.addFavorite(new FavoriteEntityStation(station.getLocationHash(), station.getName(), newBikeSystemId));
                            }
        ...
        mStationTableViewPager.setAdapter(new StationTablePagerAdapter(getSupportFragmentManager(),
                ...
                InjectorUtils.Companion.provideTableFragmentViewModelFactory(getApplication(),
                        ...
                        findMyBikesActivityViewModel.getDockTableProximityShown(),
                        findMyBikesActivityViewModel.getDockTableProximityHeaderFromResId(),
                        findMyBikesActivityViewModel.getDockTableProximityHeaderToResId(),
                ...
                InjectorUtils.Companion.provideTableFragmentViewModelFactory(getApplication(),
                        ...
                        findMyBikesActivityViewModel.isAppBarExpanded(),
                        findMyBikesActivityViewModel.isDataOutOfDate(),
                        findMyBikesActivityViewModel.getBikeTableProximityShown(),
                        findMyBikesActivityViewModel.getBikeTableProximityHeaderFromResId(),
                        findMyBikesActivityViewModel.getBikeTableProximityHeaderToResId(),
                        findMyBikesActivityViewModel.getStationA(),
                        findMyBikesActivityViewModel.getStationA(),
                        findMyBikesActivityViewModel.getDistanceToUserComparator(),
                        findMyBikesActivityViewModel.getTotalTripTimeComparator(),
    ...
    public void onFavoriteItemDeleted(final String favoriteId, boolean showUndo) {
        ...
        if(!showUndo){
            ...
            final FavoriteEntityBase toReAdd = null;//mFavoriteSheetListViewModel.getFavoriteEntityForId(favoriteId);
            Utils.Snackbar.INSTANCE.makeStyled(mCoordinatorLayout, R.string.favorite_removed,
    ...
    private boolean checkOnboarding(eONBOARDING_LEVEL _level, eONBOARDING_STEP _step){
        ...
        if (!mFavoriteSheetListViewModel.hasAtleastNValidFavorites(
...
// formatted will be HH:MM:SS or MM:SS
    ...
    private void setupBTabSelectionClosestDock(final String _favoriteId){
        ...
        final FavoriteEntityBase favorite = null;// mFavoriteSheetListViewModel.getFavoriteEntityForId(_favoriteId);
    ...
    private void setupBTableSelection(final String _selectedStationId, final boolean _silent) {
        ...
        {   //it's just an A-B trip
            ...
            if (!mFavoritePicked){
                //FavoriteEntityBase fav = mFavoriteSheetListViewModel.getFavoriteEntityForId(_selectedStationId);
                //if (fav != null)
    ...
    public void onStationListFragmentInteraction(final Uri uri) {
        ...
        if (uri.getPath().equalsIgnoreCase("/" + StationTableFragment.Companion.getSTATION_LIST_ITEM_CLICK_PATH()))
        {
            ...
            if (null != clickedStation) {
                ...
                boolean newState = !mFavoriteSheetListViewModel.isFavorite(clickedStation.getLocationHash());
            ...
            if (position == StationTablePagerAdapter.Companion.getBIKE_STATIONS()) {
                ...
                if (mStationMapFragment.getMarkerBVisibleLatLng() == null) {
                    ...
                    /*else if(mStationMapFragment.isPickedFavoriteMarkerVisible() &&
                        ...
                        locationToShow = mStationMapFragment.getMarkerPickedFavoriteVisibleLatLng();
                    else if(!mStationMapFragment.isPickedFavoriteMarkerVisible() && !mFavoriteSheetListViewModel.isFavorite(highlightedStation.getLocationHash()))
                        mAddFavoriteFAB.show();*/
    ...
    public void onLocationChanged(Location location) {
        ...
        if (mStationMapFragment != null){
            //mStationMapFragment.onUserLocationChange(location);//GONE, model handles it by itself
